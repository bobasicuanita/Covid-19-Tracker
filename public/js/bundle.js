...
},{"core-js/shim":"../../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../../node_modules/core-js/fn/regexp/escape.js"}],"apiCalls.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime/regenerator":"../../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../../node_modules/@babel/runtime/helpers/asyncToGenerator.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
exports.affected = exports.active = exports.recovered = exports.todayDeaths = exports.totalDeaths = exports.newCases = exports.totalCases = void 0;
// DOM ELEMENTS
...
exports.deathsOptions = exports.casesOptions = exports.sortCountriesByCases = exports.sortCountriesByDeaths = void 0;
...
var sortCountriesByDeaths = function sortCountriesByDeaths(response, type) {
  var countries = [];
  var numbers = [];
  var elements = []; // console.log(response.data.data.countriesList);

  var sortedDeaths = response.data.data.countriesList.map(function (el) {
    return el.deaths;
  }).sort(compareNumbers).slice(0, 10);
  sortedDeaths.forEach(function (el) {
    elements = [].concat((0, _toConsumableArray2.default)(elements), [response.data.data.countriesList.find(function (element) {
      return element.deaths === el;
    })]);
  });
  elements.forEach(function (el) {
    countries = [].concat((0, _toConsumableArray2.default)(countries), [el.country]);
    numbers = [].concat((0, _toConsumableArray2.default)(numbers), [el.deaths]);
  });
...
exports.sortCountriesByDeaths = sortCountriesByDeaths;

var sortCountriesByCases = function sortCountriesByCases(response, type) {
  var countries = [];
  var numbers = [];
  response.data.data.countriesList.slice(0, 10).forEach(function (el) {
    countries = [].concat((0, _toConsumableArray2.default)(countries), [el.country]);
...
exports.sortCountriesByCases = sortCountriesByCases;

var casesOptions = function casesOptions(countries, numbers) {
  var _options;
...
exports.casesOptions = casesOptions;

var deathsOptions = function deathsOptions(countries, numbers) {
  var _options2;
...
exports.deathsOptions = deathsOptions;
},{"@babel/runtime/helpers/defineProperty":"../../node_modules/@babel/runtime/helpers/defineProperty.js","@babel/runtime/helpers/toConsumableArray":"../../node_modules/@babel/runtime/helpers/toConsumableArray.js","./apiCalls.js":"apiCalls.js"}],"markups.js":[function(require,module,exports) {
"use strict";
...
var markupPopup = function markupPopup(country, cases, deaths, recovered, flag) {
  return '<div class="tooltip"><h3>' + country + '&nbsp;&nbsp;<img width="22" height="14" alt="Country Flag" src=' + flag + '>' + '</h3><ul><li>Total Cases: <span class="negative">' + (0, _helperFunctions.numberWithThousands)(cases) + '</li><li>Total Deaths: <span class="negative">' + (0, _helperFunctions.numberWithThousands)(deaths) + '</li><li>Recovered: <span class="positive">' + (0, _helperFunctions.numberWithThousands)(recovered) + '</li></ul></div>';
};
...
},{"./helperFunctions.js":"helperFunctions.js"}],"helperFunctions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.displayTotalData = exports.configureSearchCountry = exports.numberWithThousands = exports.date = void 0;
...
var configureSearchCountry = function configureSearchCountry(response) {
  ...
  geojson.features.forEach(function (marker) {
    ...
    var popup = new mapboxgl.Popup().setLngLat(marker.geometry.coordinates).setHTML((0, _markups.markupPopup)(response.country, response.cases, response.deaths, response.recovered, response.flag)).addTo(_mapbox.map);
    currentPopup.push(popup);
  });

  _mapbox.map.flyTo({
    center: [response.long, response.lat],
    zoom: 2,
    speed: 0.5,
    curve: 1
  });
...
var displayTotalData = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var data, day, month, year, tranformedDate, index;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 2:
            data = _context.sent;
            day = new Date(data.data.data.date).getUTCDate();
            month = new Date(data.data.data.date).getUTCMonth();
            year = new Date(data.data.data.date).getUTCFullYear();
            tranformedDate = "".concat(day, " - ").concat(month, " - ").concat(year);

            _markups.markups.push(data.data.data.totalCases);

            _markups.markups.push(data.data.data.todayCases);

            _markups.markups.push(data.data.data.totalDeaths);

            _markups.markups.push(data.data.data.todayDeaths);

            _markups.markups.push(data.data.data.totalRecovered);

            _markups.markups.push(data.data.data.totalActive);

            _markups.markups.push(data.data.data.countriesList.length);
...
},{"@babel/runtime/regenerator":"../../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../../node_modules/@babel/runtime/helpers/asyncToGenerator.js","./markups.js":"markups.js","./apiCalls.js":"apiCalls.js","./dataElements.js":"dataElements.js","./mapbox.js":"mapbox.js"}],"domElements.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ctxBarDeaths = exports.ctxBarCases = exports.input = exports.btn = void 0;
var btn = document.querySelector('.btn');
exports.btn = btn;
var input = document.getElementById('search');
exports.input = input;
var ctxBarCases = document.getElementById('casesChart').getContext('2d');
exports.ctxBarCases = ctxBarCases;
var ctxBarDeaths = document.getElementById('deathsChart').getContext('2d');
exports.ctxBarDeaths = ctxBarDeaths;
...
var showAlert = function showAlert(input) {
  // Hide previous alert
  hideAlert();
  _domElements.btn.innerText = 'Search'; // display alert
...
},{"./markups.js":"markups.js","./domElements.js":"domElements.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
window.onload = /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
  var response, countriesCases, numbersCases, chartCases, countriesDeaths, numbersDeaths, chartDeaths;
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
        ...
        case 7:
          ...
          countriesCases = (0, _charts.sortCountriesByCases)(response, 'countries');
          numbersCases = (0, _charts.sortCountriesByCases)(response, 'numbers'); // Create new Bar Chart

          chartCases = new Chart(element.ctxBarCases, (0, _charts.casesOptions)(countriesCases, numbersCases)); // // Get top 10 countries by deaths and their data

          countriesDeaths = (0, _charts.sortCountriesByDeaths)(response, 'countries');
          numbersDeaths = (0, _charts.sortCountriesByDeaths)(response, 'numbers'); // Create new Bar Chart

          chartDeaths = new Chart(element.ctxBarDeaths, (0, _charts.deathsOptions)(countriesDeaths, numbersDeaths));
...
element.btn.addEventListener('click', /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(e) {
    var response, country, code;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            // Prevent Default
            e.preventDefault(); // Change button text while searching country.

            element.btn.innerText = 'Searching...';
            if (element.input.value === '') (0, _alerts.showAlert)(element.input.value); // Perform Search
          ...
          case 5:
            ...
            country = response.data.data.countriesList.find(function (el) {
              return el.country == element.input.value.toUpperCase();
            });
            code = response.data.data.countriesList.find(function (el) {
              return el.code == element.input.value.toUpperCase();
            }); // Generate Popup

            if (country) (0, _helperFunctions.configureSearchCountry)(country);
            if (code) (0, _helperFunctions.configureSearchCountry)(code);
            if (!code && !country) (0, _alerts.showAlert)(element.input.value); // Reset input value

            element.input.value = ''; // When Search is complete revert back to old text.
...
_mapbox.map.on('click', /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(e) {
    var features, feature, responseClick, country;
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            // Get first element
            feature = features[0]; // Get response of clicked country
          ...
          case 6:
            ...
            country = responseClick.data.data.countriesList.find(function (el) {
              return el.country == feature.properties.name.toUpperCase();
            });
            if (responseClick && country) (0, _helperFunctions.configureSearchCountry)(country);
...
},{"@babel/runtime/regenerator":"../../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../../node_modules/@babel/runtime/helpers/asyncToGenerator.js","babel-polyfill":"../../node_modules/babel-polyfill/lib/index.js","./apiCalls.js":"apiCalls.js","./mapbox.js":"mapbox.js","./dataElements.js":"dataElements.js","./charts.js":"charts.js","./helperFunctions.js":"helperFunctions.js","./domElements.js":"domElements.js","./alerts.js":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
